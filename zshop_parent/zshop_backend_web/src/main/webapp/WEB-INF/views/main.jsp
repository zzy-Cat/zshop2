    ...
    <div class="content-cc">
        ...
        <div class="clear-bottom head">
            <div class="container head-cc">
                <p>在线商城
                    <span>
                        <c:if test="${Mysysuser.role.id==3}">管理员管理系统</c:if>
                        <c:if test="${Mysysuser.role.id!=3}">商家管理系统</c:if>
                    </span>
                </p>
                <div class="welcome">
                    <div class="left">欢迎您：</div>
                    <div class="right">${Mysysuser.name}</div>
                    <div class="exit" ><a href="" onclick="logoutSystemr()"><font color="#f0ffff"> 退出</font></a></div>
                </div>
            </div>
        </div>
        <!-- header end -->
        ...
        <div class="container-flude flude-cc" id="a">
            <div class="row user-setting">
                ...
                <div class="col-xs-10" id="userPanel">
                    <iframe id="frame-id" width="100%" height="100%" frameborder="0" scrolling="no">
                    </iframe>
                </div>
