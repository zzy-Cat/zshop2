            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center row">
                    <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label for="product-info" class="col-sm-4 control-label">商品介绍：</label>
                            <div class="col-sm-8">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center row">
                    <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            <label for="pro-info" class="col-sm-4 control-label">商品介绍：</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="info" id="pro-info">
                            </div>
                        </div>
                        <div class="form-group">
